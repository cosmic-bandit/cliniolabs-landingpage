          ...
          <div className="relative mb-4 mt-4">
            ...
            <div className="mt-6 flex flex-col md:flex-row justify-between items-start gap-6">
              ...
              <div className="w-full md:max-w-md text-left md:text-right">
                ...
                <button className="inline-flex items-center gap-3 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold px-8 py-4 rounded-lg transition-[background-color,transform] duration-200 shadow-lg shadow-emerald-500/25 hover:scale-105">
