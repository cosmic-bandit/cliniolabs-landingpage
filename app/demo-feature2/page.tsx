...
import { Plus, X, ChevronUp, ChevronDown, Play, Pause } from "lucide-react"
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="bg-white rounded-[28px] shadow-sm overflow-hidden relative">
                        ...
                        <div className="flex min-h-[600px]">
                            ...
                            {/* RIGHT SIDE - Visual - Fixed Size 600x600 */}
                            <div className="flex-shrink-0 relative flex items-center justify-start pr-[34px] py-[35px] pl-0">
                                <div
                                    className="relative overflow-hidden"
                                    style={{
                                        width: 600,
                                        height: 600,
                                        borderRadius: "48px" // Clean rounded corners without blur/mask
                                    }}
                                >
